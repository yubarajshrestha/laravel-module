...
class YMController extends Controller
{
    ...
    final private function resetModule($m)
    {
    ...
    final private function getParts($raw_modules)
    {
    ...
    final private function filter($string)
    {
        return ucwords($string);
    }

    final private function fileWriter($path, $str)
    {
    ...
    final private function makeModule($module = null)
    {
        $success = false;
    ...
    final private function makeModel()
    {
    ...
    final private function destroyer($dir)
    {
        if (!file_exists($dir)) {
            return true;
        }
